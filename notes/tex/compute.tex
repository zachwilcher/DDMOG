...
This sort of notation is used extensively in \cite{aceskaNewResultsDifference2025}.

We make some remarks
\begin{enumerate}
\item If \((\vec{G}, \ell)\) is DDM, then \(\wt(v_i) = 0\) (see Theorem 1 in \cite{altmanDifferenceDistanceMagic2024}),
